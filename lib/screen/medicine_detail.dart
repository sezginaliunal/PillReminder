...
import '../constant/buttonStyles.dart';
...
class MedicineDetail extends StatefulWidget {
  Medicine medicine;
  MedicineDetail(this.medicine, {super.key});
  @override
  State<MedicineDetail> createState() {
    // ignore: no_logic_in_create_state
    return _MedicineDetailState(medicine);
  }
}
...
class _MedicineDetailState extends State<MedicineDetail> {
  ...
  void initState() {
    ...
    txtDosage.text = medicine.dosage.toString();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Medicine Information : ${medicine.name}"),
      ),
      body: buildMedicineDetail(),
    );
  }
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text("Do you want delete this reminder ?"),
            actions: [
              ElevatedButton(
                style: ButtonStyles.redButton,
                onPressed: () {
              ...
              ElevatedButton(
                style: ButtonStyles.loginResetButton,
                onPressed: () async {
                  await dbHelper.delete(medicine.id ?? 0);
  ...
  void update() async {
    return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text("Are you sure"),
            content: Text("Do you want update this reminder ?"),
            actions: [
              ElevatedButton(
                style: ButtonStyles.redButton,
                onPressed: () {
              ...
              ElevatedButton(
                style: ButtonStyles.loginResetButton,
                onPressed: () async {
                  if (txtName.text.isNotEmpty && txtDosage.text.isNotEmpty) {
                    await dbHelper.update(Medicine.withId(
                      id: medicine.id,
                      name: txtName.text,
